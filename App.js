    ...
    <View style={styles.container}>
      ...
      <Modal transparent={true} animationType="fade" visible={visible}>
        <View style={styles.SecondaryContainer2}>
          ...
          <TouchableOpacity onPress={() => visModal(false)} style={{width: '65%', height: '5%', borderColor: 'red', borderWidth: 1, borderRadius: 5, justifyContent: 'center', marginTop: 15}} >
            <Text style={{fontSize: '30', fontWeight: 'bold', color: 'red', textAlign: 'center'}}>Caucular novamente</Text>
          </TouchableOpacity>
        </View>
      </Modal>
    </View>
